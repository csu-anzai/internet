...
if [[ "${release}" == "centos" ]]; then
	...
	apt-get -y install python python-dev python-setuptools openssl libssl-dev curl wget unzip gcc automake autoconf make libtool ca-certificates python3-pip subversion
fi
touch /root/testde
