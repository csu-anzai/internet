...
————————————SSR安装————————————
 ...
 ${Green_font_prefix}2.${Font_color_suffix} 卸载SSR
...
install_caddy(){
	...
	set_caddy(){
	  ...
	  -- 胖波比 --"
read -p " 请输入监听端口(listen_port)[1-65535]:" num
echo "http://:$num {
...
请对应设置SSR或V2ray的监听端口
格式如下：
\"redirect\": [\"*:server_port#127.0.0.1:listen_port\"],
"
		sleep 4s
	}
	install_caddy(){
	...
	#开始菜单
	start_menu_caddy(){
		echo && echo -e " Caddy一键安装管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
		  -- 胖波比 --
...
—————————————VPN搭建——————————————
 ...
 ————————————设置伪装—————————————
 ${Green_font_prefix}4.${Font_color_suffix} 安装 Caddy
