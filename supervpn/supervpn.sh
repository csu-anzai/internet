...
reinstall_sys(){
	...
	install_debian(){
		clear
		echo && echo -e " 版本选择 一键管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
		  -- 胖波比 --
...
————————————版本选择————————————"
		...
		bash InstallNET.sh -d $num_a -v $num_b -a
...
————————————版本选择————————————"
		echo
		read -p " 请输入版本号 [6-7]:" num_a
		read -p " 请输入版本号 [32/64]:" num_b
		
		bash InstallNET.sh -c $num_a -v $num_b -a
...
————————————版本选择————————————"
	...
	start_menu_sys(){
		clear
		echo && echo -e " 系统重装 一键管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
		  -- 胖波比 --
		  
————————————系统管理————————————
 ${Green_font_prefix}1.${Font_color_suffix} 安装 Debian
 ${Green_font_prefix}2.${Font_color_suffix} 安装 CentOS 
 ${Green_font_prefix}3.${Font_color_suffix} 安装 Ubuntu
